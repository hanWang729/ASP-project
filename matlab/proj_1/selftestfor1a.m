...
if channel_known
    ...
    ber2 = zeros(1,60);
    for i = 1:60
        [rx, evm1(i), ber1(i), symbs] = funs.sim_ofdm_known_channel(tx, h1, N_cp(i), snr, sync_err);
        [rx, evm2(i), ber2(i), symbs] = funs.sim_ofdm_known_channel(tx, h2, N_cp(i), snr, sync_err);
    end
    figure(1);
    plot(N_cp,evm1);
    hold on;
